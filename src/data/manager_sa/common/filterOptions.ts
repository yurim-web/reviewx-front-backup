 ...
 */
export type WithdrawalPaymentStatus = 'urgent' | 'request' | 'completed' | 'rejected';
 ...
 */
export const withdrawal_payment_status_label_map: Record<WithdrawalPaymentStatus, string> = {
  urgent: '긴급',
  request: '요청',
  completed: '완료',
  rejected: '반려',
 ...
 */
export type MemberType = '모범 회원' | '주의 회원' | '경고 회원' | '이용 제한 회원' | '일반 회원';
