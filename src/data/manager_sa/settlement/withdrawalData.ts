...
export const withdrawalList: WithdrawalItem[] = [
  ...
  },
  {
    ...
    amount: "1,200,000",
    remaining: "1,538,000",
    requestDate: "2026-03-04 08:00",
    paymentDate: "2026-03-04 18:56",
    type: "일반 회원",
    paymentStatus: "urgent",
    status: "영구 정지",
  },
  ...
  },
  {
    ...
    name: "일이삼사오육칠팔구십",
    account:
      "기업은행 28405876501018 일이삼사오육칠팔구십일이삼사오육칠팔구십일이삼사오육칠팔구십일이삼사오육칠팔구십일이삼사오육칠팔구십일이삼사오육칠팔구십일이삼사오육칠팔구십",
    ssn: "861256-2******",
    amount: "8,500,000",
    remaining: "1,538,000",
    requestDate: "2026-03-06 13:30",
    paymentDate: "2026-03-06 18:00",
    type: "일반 회원",
  ...
  },
  {
    ...
    amount: "12,200,000",
    remaining: "1,538,000",
    requestDate: "2026-03-07 10:10",
    paymentDate: "2026-03-07 15:30",
    type: "일반 회원",
    paymentStatus: "completed",
    status: "일시 정지",
  },
  {
    ...
    amount: "3,500,000",
    remaining: "1,538,000",
    requestDate: "2026-03-08 12:00",
    paymentDate: "2026-03-08 17:30",
    type: "일반 회원",
    paymentStatus: "completed",
    status: "정상",
  },
  {
    ...
    amount: "9,500,000",
    remaining: "1,538,000",
    requestDate: "2026-03-09 15:20",
    paymentDate: "2026-03-09 20:00",
    type: "일반 회원",
    paymentStatus: "completed",
    status: "영구 정지",
  },
  {
    ...
    amount: "6,200,000",
    remaining: "1,538,000",
    requestDate: "2026-03-10 09:45",
    paymentDate: "2026-03-10 14:15",
    type: "일반 회원",
    paymentStatus: "completed",
    status: "정상",
  },
  {
    ...
    amount: "38,800,000",
    remaining: "1,538,000",
    requestDate: "2026-03-11 11:30",
    paymentDate: "2026-03-11 16:45",
    type: "일반 회원",
    paymentStatus: "completed",
    status: "탈퇴",
  },
  ...
  },
  {
    ...
    amount: "2,500,000",
    remaining: "450,000",
    requestDate: "2026-03-14 14:20",
    paymentDate: "2026-03-14 19:00",
    type: "일반 회원",
    paymentStatus: "completed",
    status: "영구 정지",
  },
