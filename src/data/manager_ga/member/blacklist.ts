...
export const blacklist_data: BlacklistItem[] = [
  // 파트너: 주식회사 청명종합광고기획 (id: "1")
  {
    ...
    registered_date: "2026-03-01 10:20",
    registered_by: "시스템",
  },
  // 파트너: 청불 천막집 방이점 (id: "2")
  {
    ...
    block_code: "B002",
    block_reason: "무단 이탈 · 노쇼 누적",
    registered_date: "2026-03-02 11:15",
    registered_by: "시스템",
  },
  // 파트너: 명륜진사갈비 수원광교점 (id: "3")
  {
    ...
    block_code: "B002",
    block_reason: "무단 이탈 · 노쇼 누적",
    registered_date: "2026-03-03 14:30",
    registered_by: "시스템",
  },
  // 파트너: (주)플레티어 (id: "5")
  {
    ...
    registered_date: "2026-03-04 09:30",
    registered_by: "시스템",
  },
  // 파트너: 탈퇴회원테스트1 (id: "16")
  {
    ...
    registered_date: "2026-03-05 10:00",
    registered_by: "시스템",
  },
  // 파트너: 탈퇴회원테스트2 (id: "17")
  {
    ...
    block_code: "B001",
    block_reason: "반복 반려 누적",
    registered_date: "2026-03-06 11:30",
    registered_by: "시스템",
  },
  // 리뷰어: 김은지 (id: "2")
  {
    ...
    block_code: "B002",
    block_reason: "무단 이탈 · 노쇼 누적",
    registered_date: "2026-03-07 18:56",
    registered_by: "시스템",
  },
  // 리뷰어: 홍길동 (id: "3")
  {
  ...
  // 리뷰어: 탈퇴회원테스트 (id: "17")
  {
    ...
    block_code: "B001",
    block_reason: "반복 반려 누적",
    registered_date: "2026-03-08 14:20",
    registered_by: "시스템",
  },
  // 관리자: 관리자 테스트 (id: "admin_1")
  {
    ...
    registered_date: "2026-03-09 15:30",
    registered_by: "시스템",
  },
];
