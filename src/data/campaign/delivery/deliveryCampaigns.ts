...
export const deliveryCampaignsExtended: DeliveryCampaignDataExtended[] = [
  ...
  // delivery_test_shorts: 숏츠 카드 테스트 캠페인
  {
    ...deliveryCampaigns[0],
    id: "delivery_test_shorts",
    title: "[테스트] 배송형 숏츠 카드",
    brandName: "숏츠",
    channel: "유튜브",
    recruitment: {
    ...
    applicantData: {
      ...
      selectedApplicants: [
        {
          id: "sel_shorts_001",
          Id: "@shorts_selected_D",
          nickname: "선정된숏츠크리에이터D",
          userType: "인플루언서" as const,
          profileImage: "",
          memberType: "모범 회원" as const,
          subscribers: 92000,
