...
export const reviewCampaigns: ReviewCampaignData[] = [
  // review_1: 예정 탭
  {
    ...
    purchaseLink: "https://smartstore.naver.com/example-store/products/smartphone123",
    requirements: ["text_2500", "photo_20", "video_2_300", "product_link", "keyword"],
    guidelineTexts: [
  ...
  // review_12: 마감임박
  {
    ...
    purchaseLink: "https://smartstore.naver.com/example-store/products/wireless-earphone",
  ...
  // review_test_1st: 구매평 1차 테스트 (유저단 노출용)
  {
    id: "review_test_1st_all_cases",
    title: "[테스트] 구매평 1차 모든 카드 경우의 수",
    category: "구매평",
    image: "/images/main/campaign_img/eximg_1.png",
    subcategory: "생활",
    channel: "",
    points: 15000,
    description: "테스트용 구매평 1차 캠페인",
    recruitment: {
      current: 7,
      total: 10,
      partnerName: "ABC쇼핑몰",
    ...
    purchaseLink: "https://smartstore.naver.com/test",
    requirements: ["text_1500", "photo_10", "product_link", "keyword"],
    guidelineTexts: [
      "구매평 1차 테스트 캠페인입니다.",
      "구매 영수증을 확인하는 기능을 테스트할 수 있습니다.",
    ],
    contentType: "both" as const,
  },
  // review_test_2nd: 구매평 2차 테스트 (유저단 노출용)
  {
    id: "review_test_2nd_all_cases",
    title: "[테스트] 구매평 2차 모든 카드 경우의 수",
    category: "구매평",
    image: "/images/main/campaign_img/eximg_2.png",
    subcategory: "뷰티",
    channel: "",
    points: 20000,
    description: "테스트용 구매평 2차 캠페인",
    recruitment: {
      current: 7,
      total: 10,
      partnerName: "라이프스타일",
    ...
    purchaseLink: "https://smartstore.naver.com/test",
    requirements: ["text_2000", "photo_15", "product_link", "keyword"],
    guidelineTexts: [
      "구매평 2차 테스트 캠페인입니다.",
      "리뷰 이미지를 확인하는 기능을 테스트할 수 있습니다.",
    ],
    contentType: "both" as const,
  },
];
...
export const reviewCampaignsExtended: ReviewCampaignDataExtended[] = [
  ...
  // review_11: 프리미엄 비타민C 세럼 구매평
  {
    ...
    applicantData: {
      applicants: [
        {
          id: "app_review_11_네이버블로그_001",
          Id: "reviewer_review_11_001",
          nickname: "뷰티리뷰어A",
          userType: "리뷰어" as const,
          profileImage: "/images/mypage/profile.svg",
          memberType: "모범 회원" as const,
      ...
      selectedApplicants: [
        {
          id: "sel_review_11_네이버블로그_001",
          Id: "selected_review_11_001",
          nickname: "선정된뷰티리뷰어A",
          userType: "리뷰어" as const,
          profileImage: "/images/mypage/profile.svg",
          memberType: "모범 회원" as const,
  ...
  // review_test_1st: 구매평 1차 (구매기간) 모든 경우의 수 테스트 캠페인
  {
    ...reviewCampaigns[1],
    id: "review_test_1st_all_cases",
    title: "[테스트] 구매평 1차 모든 카드 경우의 수",
  ...
  // review_test_2nd: 구매평 2차 (등록기간) 모든 경우의 수 테스트 캠페인
  {
    ...reviewCampaigns[1],
    id: "review_test_2nd_all_cases",
    title: "[테스트] 구매평 2차 모든 카드 경우의 수",
 ...
 */
export function getPurchaseReviewContentsById(campaignId: string): ContentByTab | undefined {
  // 진행 중인 캠페인에서 찾기
  const campaign = reviewCampaignsExtended.find((c) => c.id === campaignId);

  if (!campaign) {
    console.warn(`[getPurchaseReviewContentsById] 캠페인을 찾을 수 없습니다: ${campaignId}`);
    return undefined;
  }
  ...
  if (campaign.contents) {
    ...
    console.log(`[getPurchaseReviewContentsById] 캠페인 ${campaignId}의 콘텐츠:`, {
...
export function createReviewCampaign(
  ...
  let finalStatus: "대기 중" | "모집 중" | "선정 중" | "구매 중" | "등록 중" | "마감" | "취소" =
    "대기 중";
