...
export const missionCampaigns: MissionCampaignData[] = [
  ...
  },
  {
    ...
    detailedSchedule: {
      ...
      registrationPeriod: "2027-04-05 ~ 2027-04-30",
    },
    campaign_detail_image: "/images/campaign_detail/exdetail_1.png",
  ...
  },
  {
    ...
    schedule: "",
    dayCount: "D-4",
    registeredAt: "2027-01-07T13:30:00.000Z", // 등록 시간
    detailedSchedule: {
      // 모집 중 - 현재 날짜 기준 (2027-01-09 ~ 2027-01-25)
      applicationStart: "2026-07-01",
      applicationEnd: "2026-07-25",
      announcement: "2027-01-27",
      registrationPeriod: "2027-01-30 ~ 2027-03-07",
    },
    campaign_detail_image: "/images/campaign_detail/exdetail_1.png",
  ...
  },
  {
    ...
    schedule: "",
    dayCount: "D-5",
    registeredAt: "2027-01-11T10:00:00.000Z", // 등록 시간
    detailedSchedule: {
  ...
  },
  {
    ...
    detailedSchedule: {
      ...
      registrationPeriod: "2027-03-02 ~ 2027-03-28",
    },
    campaign_detail_image: "/images/campaign_detail/exdetail_1.png",
  ...
  },
  {
    ...
    detailedSchedule: {
      ...
      registrationPeriod: "2027-03-10 ~ 2027-03-24",
    },
    campaign_detail_image: "/images/campaign_detail/exdetail_1.png",
  ...
  // mission_13: 링크만 미션형 (등록기간 진행 중)
  {
    ...
    schedule: "",
    dayCount: "D-1",
    registeredAt: "2027-01-05T10:00:00.000Z", // 등록 시간
    detailedSchedule: {
      // 선정 완료 - 등록기간 진행 중 (오늘 날짜 기준 2027-01-07)
      applicationStart: "2026-07-01",
      applicationEnd: "2026-07-16",
      announcement: "2027-03-01",
      registrationPeriod: "2027-03-02 ~ 2027-03-08", // 등록기간 길게 설정
    },
    campaign_detail_image: "/images/campaign_detail/exdetail_1.png",
  ...
  // mission_14: 이미지만 미션형 (등록기간 진행 중)
  {
    ...
    schedule: "",
    dayCount: "D-1",
    registeredAt: "2027-01-05T11:00:00.000Z", // 등록 시간
    detailedSchedule: {
      // 선정 완료 - 등록기간 진행 중 (오늘 날짜 기준 2027-01-07)
      applicationStart: "2026-07-01",
      applicationEnd: "2026-07-27",
      announcement: "2027-01-03",
      registrationPeriod: "2027-01-08 ~ 2027-03-15", // 등록기간 길게 설정
    },
    campaign_detail_image: "/images/campaign_detail/exdetail_1.png",
  ...
  // mission_15: 링크 + 이미지 미션형 (등록기간 진행 중)
  {
    id: "4015",
    title:
      "종합 리뷰 식품 미션형종합 리뷰 식품 미션형종합 리뷰 식품 미션형종합 리뷰 식품 미션형ㅇㅇㅇㄴㅇㄹㄴㅇㄹ",
    category: "미션형",
    image: "/images/main/campaign_img/eximg_4.png",
    subcategory: "식품",
    channel: "", // 미션형은 채널 없음
    ...
    schedule: "",
    dayCount: "D-1",
    registeredAt: "2027-01-06T09:30:00.000Z", // 등록 시간
    detailedSchedule: {
      // 선정 완료 - 등록기간 진행 중 (오늘 날짜 기준 2027-01-07)
      applicationStart: "2026-07-01",
      applicationEnd: "2026-07-12",
      announcement: "2027-01-04",
      registrationPeriod: "2027-01-08 ~ 2027-03-10", // 등록기간 길게 설정
    },
    campaign_detail_image: "/images/campaign_detail/exdetail_1.png",
  ...
  // mission_test_both: 미션형 링크+이미지 테스트 (유저단 노출용)
  {
    ...
    schedule: "",
    dayCount: "D-4",
    registeredAt: "2027-01-12T10:00:00.000Z",
    detailedSchedule: {
      applicationStart: "2026-07-01",
  ...
  // mission_test_link: 미션형 링크만 테스트 (유저단 노출용)
  {
    ...
    schedule: "",
    dayCount: "D-2",
    registeredAt: "2027-01-22T10:00:00.000Z",
    detailedSchedule: {
      applicationStart: "2026-07-01",
      applicationEnd: "2026-08-12",
      announcement: "2027-03-02",
  ...
  // mission_test_image: 미션형 이미지만 테스트 (유저단 노출용)
  {
    ...
    schedule: "",
    dayCount: "D-1",
    registeredAt: "2027-01-25T10:00:00.000Z",
    detailedSchedule: {
      applicationStart: "2026-07-01",
      applicationEnd: "2026-08-12",
      announcement: "2027-03-02",
  ...
  // mission_4020: 운동 루틴 공유 미션 (db.json 연동용)
  {
    id: "4020",
    title: "운동 루틴 공유 미션",
    category: "미션형",
    ...
    subcategory: "여행",
    points: 25000,
    description: "운동 루틴 공유 미션 체험단 모집",
    recruitment: {
      current: 0,
      total: 10,
    },
    ...
    detailedSchedule: {
      ...
      applicationEnd: "2026-07-25",
      announcement: "2027-01-28",
      registrationPeriod: "2027-03-05 ~ 2027-03-25",
    },
    campaign_detail_image: "/images/campaign_detail/exdetail_1.png",
...
export const missionCampaignsExtended: MissionCampaignDataExtended[] = [
    ...
    contents: {
      waiting: [
        ...
        },
        {
          ...
          createdAt: "2026-12-26T11:00:00.000Z",
          status: "검수" as const,
          userType: "인플루언서" as const,
          nickname: "인테리어인플루언서B",
          channelId: "blog_026",
      ...
      reviewing: [
        {
          ...
          createdAt: "2026-12-24T09:00:00.000Z",
          status: "검수중" as const,
          userType: "리뷰어" as const,
          nickname: "홈데코리뷰어C",
          channelId: "blog_027",
          channel: "네이버 블로그",
          updatedAt: "2026-12-25T10:00:00.000Z",
          isRejected: false,
          isLate: false,
          profileImage: "",
          actionType: 4, // 링크만
      ...
      completed: [
        {
          ...
          createdAt: "2026-12-23T08:00:00.000Z",
          status: "완료" as const,
          userType: "리뷰어" as const,
          nickname: "선정된홈데코리뷰어1",
          channelId: "blog_028",
          channel: "네이버 블로그",
          updatedAt: "2026-12-24T09:00:00.000Z",
          isLate: false,
          profileImage: "",
          actionType: 4, // 링크만
        },
  ...
  // mission_4: 패션 미션형
  {
    ...
    applicantData: {
      applicants: [
        ...
        {
          id: "app_mission_4_네이버클립_001",
          Id: "reviewer_mission_4_003",
          nickname: "패션크리에이터정민아",
          userType: "인플루언서" as const,
          profileImage: "",
          memberType: "모범 회원" as const,
      ...
      selectedApplicants: [
        {
          id: "sel_mission_4_인스타그램_001",
          Id: "selected_mission_4_001",
          nickname: "선정된패션인플루언서",
          userType: "인플루언서" as const,
          profileImage: "",
          memberType: "모범 회원" as const,
  ...
  // mission_12: 이미지 전용 미션형
  {
    ...missionCampaigns[6],
    applicantData: {
      applicants: [
        {
          id: "app_mission_12_인스타그램_001",
          Id: "reviewer_mission_12_001",
          nickname: "뷰티인플루언서김지연",
          userType: "인플루언서" as const,
          profileImage: "",
          memberType: "모범 회원" as const,
          ...
          totalVisits: 850000,
          neighbors: 2400,
          memo: "이미지 전문 인플루언서입니다.",
          selectionStatus: "미선택" as const,
          channel: "인스타그램",
          registrationDate: "2027-01-14",
        },
        {
          id: "app_mission_12_유튜브_001",
          Id: "reviewer_mission_12_002",
          nickname: "뷰티크리에이터박서연",
          userType: "리뷰어" as const,
          profileImage: "",
          memberType: "모범 회원" as const,
          ...
          totalVisits: 680000,
          neighbors: 1900,
          memo: "영상 및 이미지 콘텐츠 전문가입니다.",
          selectionStatus: "미선택" as const,
          channel: "유튜브",
          registrationDate: "2027-01-15",
        },
        {
          id: "app_mission_12_네이버블로그_001",
          Id: "reviewer_mission_12_003",
          nickname: "뷰티리뷰어이수진",
          userType: "리뷰어" as const,
          profileImage: "",
          memberType: "모범 회원" as const,
      ...
      selectedApplicants: [
        {
          id: "sel_mission_12_인스타그램_001",
          Id: "selected_mission_12_001",
          nickname: "선정된이미지전문가",
          userType: "인플루언서" as const,
          profileImage: "",
          memberType: "모범 회원" as const,
          ...
          totalVisits: 1020000,
          neighbors: 3100,
          memo: "이미 선정된 이미지 콘텐츠 전문가입니다.",
          selectionStatus: "선정하기" as const,
          channel: "인스타그램",
          registrationDate: "2027-01-13",
        },
      ],
    },
    contents: {
      waiting: [
        {
          id: "content_mission_12_waiting_001",
          ...
          extendedDeadline: "2027-03-10",
        },
      ],
      reviewing: [
        {
          id: "content_mission_12_reviewing_001",
          createdAt: "2027-01-28T14:30:00.000Z",
          status: "검수중" as const,
          userType: "리뷰어" as const,
          nickname: "뷰티리뷰어이수진",
          channelId: "blog_048",
      ...
      completed: [
        {
          id: "content_mission_12_completed_001",
          createdAt: "2027-01-25T16:00:00.000Z",
          status: "완료" as const,
          userType: "리뷰어" as const,
          nickname: "뷰티크리에이터박서연",
          channelId: "youtube_047",
          channel: "유튜브",
          updatedAt: "2027-01-26T10:00:00.000Z",
          isLate: true,
          profileImage: "",
          actionType: 3, // 이미지만 (contentType: "image")
        },
    ...
    contents: {
      ...
      completed: [
        ...
        },
        {
          ...
          createdAt: "2026-12-18T10:00:00.000Z",
          status: "완료" as const,
          userType: "인플루언서" as const,
          nickname: "지각제출디지털인플루언서",
          channelId: "shopping_005",
          channel: "네이버쇼핑",
          updatedAt: "2026-12-21T17:37:00.000Z",
          isLate: true,
          profileImage: "",
          actionType: 2,
        },
  ...
  // mission_9: 뷰티 미션형
  {
    ...
    applicantData: {
      ...
      selectedApplicants: [
        {
          id: "sel_mission_9_올리브영_001",
          Id: "selected_mission_9_001",
          nickname: "뷰티리뷰어A",
          userType: "리뷰어" as const,
          profileImage: "",
          memberType: "모범 회원" as const,
        ...
        {
          id: "sel_mission_9_올리브영_002",
          Id: "selected_mission_9_002",
          nickname: "뷰티인플루언서B",
          userType: "인플루언서" as const,
          profileImage: "",
          memberType: "모범 회원" as const,
    ...
    contents: {
      waiting: [
        ...
        // 3. 연장 승인 후 아직 등록 안함 (이미지+링크)
        {
          ...
          actionType: 2, // 이미지+링크 (contentType: "both")
          isExtensionApproved: true,
          extendedDeadline: "2027-01-20",
        },
        // 4. 반려 처리 (이미지+링크)
        {
          id: "content_mission_9_waiting_004",
          createdAt: "2026-12-28T08:00:00.000Z",
          status: "검수" as const,
          userType: "인플루언서" as const,
          nickname: "뷰티인플루언서D",
          channelId: "olive_004",
        ...
        // 5. 신고 처리 (이미지+링크)
        {
          ...
          createdAt: "2026-12-27T07:00:00.000Z",
          status: "검수" as const,
          userType: "리뷰어" as const,
          nickname: "뷰티리뷰어E",
          channelId: "olive_005",
      ...
      reviewing: [
        ...
        // 2. 수정 (이미지+링크)
        {
          ...
          channelId: "olive_007",
          channel: "올리브영",
          updatedAt: "2026-12-29T10:00:00.000Z", // 수정됨
          isRejected: false,
          isLate: false,
          profileImage: "",
          actionType: 2, // 이미지+링크 (contentType: "both")
        ...
        // 3. 지각 등록 (이미지+링크)
        {
          ...
          channelId: "olive_008",
          channel: "올리브영",
          updatedAt: "2026-12-30T11:00:00.000Z", // 지각 등록
          isRejected: false,
          isLate: true, // 지각 등록
          profileImage: "",
          actionType: 2, // 이미지+링크 (contentType: "both")
      ...
      completed: [
        ...
        // 2. 확인 완료 (이미지+링크)
        {
          ...
          channelId: "olive_010",
          channel: "올리브영",
          updatedAt: "2026-12-26T08:00:00.000Z",
          isLate: false,
          profileImage: "",
          actionType: 2, // 이미지+링크 (contentType: "both")
        },
        // 3. 확인 완료 (이미지+링크)
        {
          ...
          channelId: "olive_011",
          channel: "올리브영",
          updatedAt: "2026-12-25T07:00:00.000Z",
          isLate: false,
          profileImage: "",
          actionType: 2, // 이미지+링크 (contentType: "both")
        },
  ...
  // mission_4021: 독서 리뷰 미션 (db.json 연동용)
  {
    ...missionCampaigns[0],
    id: "4021",
    title: "독서 리뷰 미션",
    ...
    subcategory: "육아",
    points: 65000,
    description: "독서 리뷰 미션 체험단 모집",
    recruitment: { current: 12, total: 20 },
    registeredAt: "2027-05-20T00:00:00.000Z",
    detailedSchedule: {
      applicationStart: "2026-07-01",
      applicationEnd: "2027-06-20",
      announcement: "2027-06-25",
      registrationPeriod: "2026-07-05 ~ 2026-07-25",
    },
    ...
    applicantData: {
      applicants: [
        {
          id: "app_4021_001",
          Id: "blog.naver.com/book_reviewer_a",
          nickname: "독서리뷰어A",
          userType: "리뷰어" as const,
          profileImage: "",
          memberType: "모범 회원" as const,
          ...
          selectionStatus: "미선택" as const,
          channel: "네이버블로그",
          registrationDate: "2027-06-05",
        } as any,
        {
          id: "app_4021_002",
          Id: "blog.naver.com/book_influencer_b",
          nickname: "책인플루언서B",
          userType: "인플루언서" as const,
          profileImage: "",
          memberType: "모범 회원" as const,
          ...
          totalVisits: 92000,
          neighbors: 3500,
          memo: "책 리뷰 전문 인플루언서입니다.",
          selectionStatus: "미선택" as const,
          channel: "네이버블로그",
          registrationDate: "2027-06-06",
        } as any,
      ],
      selectedApplicants: [],
    },
    contents: { waiting: [], reviewing: [], completed: [] },
  },
  // mission_4020: 운동 루틴 공유 미션 (db.json 연동용)
  {
    ...
    applicantData: {
      applicants: [
        ...
        {
          id: "app_4020_002",
          Id: "@workout_influencer_B",
          nickname: "헬스인플루언서B",
          userType: "인플루언서" as const,
          profileImage: "",
          memberType: "모범 회원" as const,
          memo: "헬스/운동 전문 인플루언서입니다.",
          selectionStatus: "미선택" as const,
          channel: "쇼츠",
        ...
        {
          id: "app_4020_003",
          Id: "@workout_creator_C",
          nickname: "피트니스크리에이터C",
          userType: "리뷰어" as const,
          profileImage: "",
          memberType: "주의 회원" as const,
          memo: "피트니스 전문 콘텐츠 제작자입니다.",
          selectionStatus: "미선택" as const,
          channel: "쇼츠",
          registrationDate: "2027-01-07",
        } as any,
      ],
      selectedApplicants: [],
    },
