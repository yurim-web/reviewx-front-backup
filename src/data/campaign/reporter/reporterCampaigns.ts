...
export const reporterCampaigns: ReporterCampaignData[] = [
  ...
  // reporter_2: 연장요청 탭
  {
    ...
    schedule: "",
    dayCount: "D-3",
    registeredAt: "2027-01-08T11:15:00.000Z", // 등록 시간
    detailedSchedule: {
      // 오픈 예정 - 모집 시작 전
      applicationStart: "2026-07-01",
      applicationEnd: "2026-08-08",
      announcement: "2027-03-26",
      registrationPeriod: "2027-03-28 ~ 2027-03-15",
    },
    campaign_detail_image: "/images/campaign_detail/exdetail_1.png",
    channel: "인스타그램",
  ...
  // reporter_5: 종료 탭
  {
    ...
    detailedSchedule: {
      ...
      registrationPeriod: "2026-12-20 ~ 2027-03-27",
    },
    campaign_detail_image: "/images/campaign_detail/exdetail_1.png",
    channel: "유튜브",
  ...
  // reporter_6: 신청 탭
  {
    ...
    schedule: "",
    dayCount: "D-4",
    registeredAt: "2027-01-07T15:20:00.000Z", // 등록 시간
    detailedSchedule: {
      // 모집 중 - 현재 날짜(2027-03-03) 기준 신청 진행 중 상태 유지
      applicationStart: "2026-07-01",
      applicationEnd: "2026-08-15",
  ...
  // reporter_9: 진행 탭
  {
    ...
    detailedSchedule: {
      ...
      registrationPeriod: "2026-12-08 ~ 2027-01-29",
    },
    campaign_detail_image: "/images/campaign_detail/exdetail_1.png",
    channel: "인스타그램",
  ...
  },
  {
    ...
    detailedSchedule: {
      ...
      announcement: "2027-04-18",
      registrationPeriod: "2027-04-20 ~ 2027-05-05",
    },
    campaign_detail_image: "/images/campaign_detail/exdetail_1.png",
    channel: "클립",
  ...
  // reporter_test: 기자단 테스트 (유저단 노출용)
  {
    ...
    schedule: "",
    dayCount: "D-8",
    registeredAt: "2027-01-10T10:00:00.000Z",
    detailedSchedule: {
      applicationStart: "2026-07-01",
...
export const reporterCampaignsExtended: ReporterCampaignDataExtended[] = [
  // reporter_1: 테크 기자단 (릴스)
  {
    ...reporterCampaigns[0],
    applicantData: {
      applicants: [
        {
          id: "app_reporter_1_릴스_001",
      ...
      selectedApplicants: [
        {
          id: "sel_reporter_1_릴스_001",
          Id: "selected_reporter_1_001",
          nickname: "선정된테크기자단A",
          userType: "리뷰어" as const,
          profileImage: "",
          memberType: "모범 회원" as const,
  ...
  // reporter_11: 뷰티 트렌드 기자단 (네이버클립)
  {
    ...reporterCampaigns[10],
    applicantData: {
      applicants: [
        {
          id: "app_reporter_11_네이버클립_001",
          Id: "reviewer_reporter_11_001",
          nickname: "뷰티트렌드기자단A",
          userType: "리뷰어" as const,
          profileImage: "",
          memberType: "모범 회원" as const,
        ...
        } as any,
        {
          ...
          selectionStatus: "미선택" as const,
          channel: "네이버클립" as const,
          registrationDate: "2027-01-27",
        } as any,
      ],
      selectedApplicants: [
        {
          id: "sel_reporter_11_네이버클립_001",
          Id: "selected_reporter_11_001",
          nickname: "선정된뷰티기자단A",
          userType: "리뷰어" as const,
          profileImage: "",
          memberType: "모범 회원" as const,
    ...
    contents: {
      waiting: [
        ...
        },
        {
          ...
          createdAt: "2027-03-01T11:00:00.000Z",
          status: "검수" as const,
          userType: "인플루언서" as const,
          nickname: "디지털인플루언서B",
      ...
      reviewing: [
        {
          ...
          createdAt: "2027-01-29T09:00:00.000Z",
          status: "검수중" as const,
          userType: "리뷰어" as const,
          nickname: "IT전문기자단C",
          channelId: "naverclip_023",
          channel: "클립",
          updatedAt: "2027-01-30T10:00:00.000Z",
          isRejected: false,
          isLate: false,
        },
        {
          id: "content_reporter_12_reviewing_002",
          createdAt: "2027-01-30T14:00:00.000Z",
          status: "검수중" as const,
          userType: "인플루언서" as const,
          nickname: "테크리포터D",
          channelId: "naverclip_024",
          channel: "클립",
          updatedAt: "2027-01-31T15:00:00.000Z",
          isRejected: false,
          isLate: false,
        },
      ],
      completed: [
        {
          ...
          createdAt: "2027-01-25T08:00:00.000Z",
          status: "완료" as const,
          userType: "리뷰어" as const,
          nickname: "디지털기자단리뷰어A",
          channelId: "naverclip_025",
          channel: "클립",
          updatedAt: "2027-01-27T09:00:00.000Z",
          isLate: false,
        },
        {
          id: "content_reporter_12_completed_002",
          createdAt: "2027-01-26T10:00:00.000Z",
          status: "완료" as const,
          userType: "인플루언서" as const,
          nickname: "디지털인플루언서B",
          channelId: "naverclip_026",
          channel: "클립",
          updatedAt: "2027-01-28T11:00:00.000Z",
          isLate: false,
        },
      ],
    },
