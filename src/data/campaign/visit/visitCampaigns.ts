...
export const visitCampaigns: VisitCampaignData[] = [
  // visit_1: 예정 탭
  {
    ...
    schedule: "",
    dayCount: "D-5",
    registeredAt: "2027-01-10T09:30:00.000Z", // 등록 시간
    detailedSchedule: {
  ...
  // visit_2: 연장요청 탭
  {
    ...
    detailedSchedule: {
      ...
      purchasePeriod: "2027-04-02 ~ 2027-04-20",
    },
    partnerName: "펫프렌즈",
    campaign_detail_image: "/images/campaign_detail/exdetail_1.png",
    channel: "인스타그램",
  ...
  // visit_3: 신청 탭
  {
    ...
    schedule: "",
    dayCount: "D-3",
    registeredAt: "2027-01-09T11:15:00.000Z", // 등록 시간
    detailedSchedule: {
      // 항상 신청 내역 테스트가 가능하도록, 현재 날짜(2027-03-26) 기준으로 모집 진행 중 상태로 유지
      applicationStart: "2026-07-01",
      applicationEnd: "2026-08-15",
      announcement: "2027-04-02",
      purchasePeriod: "2027-04-02 ~ 2027-04-17",
    },
    partnerName: "레더리아",
    campaign_detail_image: "/images/campaign_detail/exdetail_1.png",
    channel: "인스타그램",
  ...
  // visit_4: 예정 탭
  {
    ...
    detailedSchedule: {
      ...
      announcement: "2027-03-20",
      purchasePeriod: "2027-03-20 ~ 2027-03-27",
    },
    partnerName: "글로벌트레이드",
    campaign_detail_image: "/images/campaign_detail/exdetail_1.png",
    channel: "유튜브",
  ...
  // visit_5: 종료 탭
  {
    ...
    detailedSchedule: {
      ...
      announcement: "2027-01-20",
      purchasePeriod: "2027-01-20 ~ 2027-03-05",
    },
    partnerName: "테크솔루션",
    campaign_detail_image: "/images/campaign_detail/exdetail_1.png",
    channel: "네이버 블로그",
  ...
  // visit_6: 신청 탭
  {
    ...
    schedule: "",
    dayCount: "D-4",
    registeredAt: "2027-01-11T15:20:00.000Z", // 등록 시간
    detailedSchedule: {
  ...
  // visit_7: 진행 탭
  {
    ...
    schedule: "",
    dayCount: "D-2",
    registeredAt: "2026-12-28T09:15:00.000Z", // 등록 시간
    detailedSchedule: {
      // 진행 중 - 등록 기간 중
      applicationStart: "2026-07-01",
      applicationEnd: "2026-07-15",
      announcement: "2027-01-17",
      purchasePeriod: "2027-01-17 ~ 2027-03-05",
    },
    partnerName: "ABC쇼핑몰",
    campaign_detail_image: "/images/campaign_detail/exdetail_1.png",
    channel: "인스타그램",
  ...
  // visit_8: 종료 탭
  {
    ...
    schedule: "",
    dayCount: "D-8",
    registeredAt: "2026-12-26T14:00:00.000Z", // 등록 시간
    detailedSchedule: {
      // 진행 중 - 등록 기간 중
      applicationStart: "2026-07-01",
      applicationEnd: "2026-07-17",
      announcement: "2027-01-19",
      purchasePeriod: "2027-01-19 ~ 2027-03-08",
    },
    partnerName: "그린라이프",
    campaign_detail_image: "/images/campaign_detail/exdetail_1.png",
    channel: "유튜브",
  ...
  // visit_10: 취소 탭
  {
    ...
    detailedSchedule: {
      ...
      purchasePeriod: "2026-12-25 ~ 2026-12-02",
    },
    partnerName: "헬스앤라이프",
    campaign_detail_image: "/images/campaign_detail/exdetail_1.png",
    channel: "네이버 블로그",
  ...
  },
  {
    ...
    detailedSchedule: {
      ...
      announcement: "2027-03-27",
      purchasePeriod: "2027-03-27 ~ 2027-03-10",
    },
    partnerName: "테크솔루션",
    campaign_detail_image: "/images/campaign_detail/exdetail_1.png",
    channel: "네이버 블로그",
  ...
  // visit_12: 마감임박 캠페인 (홈 메인페이지용)
  {
    ...
    schedule: "",
    dayCount: "마감임박",
    registeredAt: "2026-12-26T11:30:00.000Z", // 등록 시간
    detailedSchedule: {
      // 모집 중 - 마감 임박
      applicationStart: "2026-07-01",
      applicationEnd: "2026-07-29",
      announcement: "2027-01-31",
      purchasePeriod: "2027-01-31 ~ 2027-03-10",
    },
    partnerName: "홈트레이닝",
    campaign_detail_image: "/images/campaign_detail/exdetail_1.png",
    channel: "네이버 블로그",
  ...
  // visit_13: 마감임박 - 네이버 클립 채널
  {
    ...
    detailedSchedule: {
      ...
      purchasePeriod: "2027-03-01 ~ 2027-03-12",
    },
    partnerName: "테크솔루션",
    campaign_detail_image: "/images/campaign_detail/exdetail_1.png",
    channel: "클립",
  ...
  // visit_test: 방문형 테스트 (유저단 노출용)
  {
    ...
    schedule: "",
    dayCount: "D-6",
    registeredAt: "2027-01-18T10:00:00.000Z",
    detailedSchedule: {
      applicationStart: "2026-07-01",
...
export const visitCampaignsExtended: VisitCampaignDataExtended[] = [
    ...
    contents: {
      waiting: [
        ...
        },
        {
          ...
          createdAt: "2026-12-22T12:00:00.000Z",
          status: "검수" as const,
          userType: "인플루언서" as const,
          nickname: "김덮밥",
          channelId: "insta_003",
      ...
      reviewing: [
        ...
        },
        {
          ...
          createdAt: "2026-12-19T10:00:00.000Z",
          status: "검수중" as const,
          userType: "인플루언서" as const,
          nickname: "카페리뷰어A",
          channelId: "insta_005",
          channel: "인스타그램",
          updatedAt: "2026-12-20T11:00:00.000Z",
          isRejected: false,
          isLate: false,
          profileImage: "",
        },
      ...
      completed: [
        ...
        },
        {
          ...
          createdAt: "2026-12-16T09:00:00.000Z",
          status: "완료" as const,
          userType: "인플루언서" as const,
          nickname: "카페인플루언서C",
          channelId: "insta_007",
          channel: "인스타그램",
          updatedAt: "2026-12-17T10:00:00.000Z",
          isLate: false,
          profileImage: "",
        },
        {
          id: "content_visit_2_completed_003",
          createdAt: "2026-12-17T10:00:00.000Z",
          status: "완료" as const,
          userType: "리뷰어" as const,
          nickname: "카페리뷰어D",
          channelId: "insta_008",
          channel: "인스타그램",
          updatedAt: "2026-12-18T11:00:00.000Z",
          isLate: false,
          profileImage: "",
        },
        {
          id: "content_visit_2_completed_004",
          createdAt: "2026-12-18T11:00:00.000Z",
          status: "완료" as const,
          userType: "인플루언서" as const,
          nickname: "카페인플루언서E",
          channelId: "insta_009",
          channel: "인스타그램",
          updatedAt: "2026-12-19T12:00:00.000Z",
          isLate: false,
          profileImage: "",
        },
        {
          id: "content_visit_2_completed_005",
          createdAt: "2026-12-19T12:00:00.000Z",
          status: "완료" as const,
          userType: "리뷰어" as const,
          nickname: "카페리뷰어F",
          channelId: "insta_010",
          channel: "인스타그램",
          updatedAt: "2026-12-20T13:00:00.000Z",
          isLate: false,
          profileImage: "",
        },
        {
          id: "content_visit_2_completed_006",
          createdAt: "2026-12-20T13:00:00.000Z",
          status: "완료" as const,
          userType: "인플루언서" as const,
          nickname: "카페인플루언서G",
          channelId: "insta_011",
          channel: "인스타그램",
          updatedAt: "2026-12-21T14:00:00.000Z",
          isLate: false,
          profileImage: "",
        },
        {
          id: "content_visit_2_completed_007",
          createdAt: "2026-12-21T14:00:00.000Z",
          status: "완료" as const,
          userType: "리뷰어" as const,
          nickname: "카페리뷰어H",
          channelId: "insta_012",
          channel: "인스타그램",
          updatedAt: "2026-12-22T15:00:00.000Z",
          isLate: false,
          profileImage: "",
        },
        {
          id: "content_visit_2_completed_008",
          createdAt: "2026-12-22T15:00:00.000Z",
          status: "완료" as const,
          userType: "인플루언서" as const,
          nickname: "카페인플루언서I",
          channelId: "insta_013",
          channel: "인스타그램",
          updatedAt: "2026-12-23T16:00:00.000Z",
          isLate: false,
          profileImage: "",
        },
      ],
    ...
    contents: {
      waiting: [
        {
          ...
          createdAt: "2026-12-24T10:00:00.000Z",
          status: "검수" as const,
          userType: "리뷰어" as const,
          nickname: "쇼핑몰대기리뷰어A",
          channelId: "blog_005",
      ...
      reviewing: [
        ...
        },
        {
          ...
          channelId: "blog_002",
          channel: "네이버 블로그",
          updatedAt: "2026-12-26T11:00:00.000Z",
          isRejected: false,
          isLate: false,
          profileImage: "",
        },
      ...
      completed: [
        ...
        },
        {
          ...
          createdAt: "2026-12-23T13:00:00.000Z",
          status: "완료" as const,
          userType: "인플루언서" as const,
          nickname: "쇼핑몰인플루언서D",
          channelId: "blog_004",
          channel: "네이버 블로그",
          updatedAt: "2026-12-28T13:00:00.000Z",
          isLate: false,
          profileImage: "",
        },
      ],
    ...
    contents: {
      ...
      completed: [
        ...
        },
        {
          ...
          channelId: "blog_040",
          channel: "네이버 블로그",
          updatedAt: "2026-12-22T17:37:00.000Z",
          isLate: true,
          profileImage: "",
        },
      ],
    ...
    contents: {
      waiting: [
        ...
        },
        {
          ...
          createdAt: "2026-12-29T11:00:00.000Z",
          status: "검수" as const,
          userType: "인플루언서" as const,
          nickname: "힐링인플루언서B",
          channelId: "insta_015",
      ...
      completed: [
        ...
        },
        {
          ...
          channelId: "insta_018",
          channel: "인스타그램",
          updatedAt: "2026-12-26T10:00:00.000Z",
          isLate: false,
          profileImage: "",
        },
      ],
    ...
    contents: {
      waiting: [
        ...
        // 1-2️⃣ 연장 요청이 있는 대기 카드 (테스트용 추가 1)
        {
          ...
          createdAt: "2026-12-30T11:30:00.000Z",
          status: "검수" as const,
          userType: "리뷰어" as const,
        ...
        // 1-3️⃣ 연장 요청이 있는 대기 카드 (테스트용 추가 2)
        {
          ...
          createdAt: "2026-12-30T12:15:00.000Z",
          status: "검수" as const,
          userType: "인플루언서" as const,
        ...
        //    - 실제 기한/연장된 기한 날짜는 페이지 컴포넌트에서 하드코딩으로 전달합니다
        {
          ...
          createdAt: "2026-12-29T10:00:00.000Z",
          status: "검수" as const,
          userType: "리뷰어" as const,
          nickname: "놀이공원방문리뷰어C",
          channelId: "blog_100",
      ...
      reviewing: [
        ...
        //    - isLate가 true인 경우
        {
          ...
          channelId: "blog_102",
          channel: "네이버 블로그",
          updatedAt: "2026-12-30T15:30:00.000Z",
          isRejected: false,
          isLate: true,
          profileImage: "",
        },
        ...
        // 5️⃣ 수정 (추가 테스트용)
        {
          ...
          createdAt: "2026-12-29T14:00:00.000Z",
          status: "검수중" as const,
          userType: "인플루언서" as const,
          nickname: "테마파크인플루언서C",
          channelId: "youtube_016",
          channel: "유튜브",
          updatedAt: "2026-12-30T09:20:00.000Z",
          isRejected: false,
          isLate: false,
          profileImage: "",
        },
        // 6️⃣ 지각 등록 (추가 테스트용)
        {
          ...
          createdAt: "2026-12-29T16:00:00.000Z",
          status: "검수중" as const,
          userType: "리뷰어" as const,
          nickname: "놀이공원방문리뷰어C",
          channelId: "blog_103",
          channel: "네이버 블로그",
          updatedAt: "2026-12-31T10:45:00.000Z",
          isRejected: false,
          isLate: true,
          profileImage: "",
        },
      ...
      completed: [
        ...
        },
        {
          ...
          createdAt: "2026-12-27T09:00:00.000Z",
          status: "완료" as const,
          userType: "인플루언서" as const,
          nickname: "테마파크인플루언서D",
        ...
        },
        {
          ...
          createdAt: "2026-12-24T14:00:00.000Z",
          status: "완료" as const,
          userType: "인플루언서" as const,
          nickname: "놀이공원인플루언서F",
          channelId: "naver_blog_019",
          channel: "네이버 블로그",
          updatedAt: "2026-12-25T15:00:00.000Z",
          isLate: true,
          profileImage: "",
        },
        {
          id: "content_visit_9_completed_005",
          createdAt: "2026-12-23T16:00:00.000Z",
          status: "완료" as const,
          userType: "리뷰어" as const,
          nickname: "테마파크방문리뷰어G",
          channelId: "youtube_020",
          channel: "유튜브",
          updatedAt: "2026-12-24T17:00:00.000Z",
          isLate: false,
          profileImage: "",
        },
        {
          id: "content_visit_9_completed_006",
          createdAt: "2026-12-22T18:00:00.000Z",
          status: "완료" as const,
          userType: "인플루언서" as const,
          nickname: "놀이공원체험인플루언서H",
          channelId: "instagram_021",
          channel: "인스타그램",
          updatedAt: "2026-12-23T19:00:00.000Z",
          isLate: false,
          profileImage: "",
        },
        {
          id: "content_visit_9_completed_007",
          createdAt: "2026-12-21T20:00:00.000Z",
          status: "완료" as const,
          userType: "리뷰어" as const,
          nickname: "테마파크리뷰어I",
          channelId: "naver_blog_022",
          channel: "네이버 블로그",
          updatedAt: "2026-12-22T21:00:00.000Z",
          isLate: false,
          profileImage: "",
        },
        {
          ...
          channel: "유튜브",
          updatedAt: "2026-12-21T23:00:00.000Z",
          isLate: true,
          profileImage: "",
        },
        {
  ...
  // visit_test: 모든 경우의 수 테스트 캠페인
  {
    ...
    detailedSchedule: {
      ...
      applicationEnd: "2026-08-12",
      announcement: "2027-03-02",
      purchasePeriod: "2027-01-30 ~ 2027-05-05",
    },
    applicantData: {
      applicants: [],
      selectedApplicants: [],
