...
export async function generateMetadata({
  ...
  if (!campaign) {
    return {
      title: "ReviewX | 미션형 캠페인 상세",
      description: "ReviewX 미션형 캠페인 상세 페이지",
    };
  }

  return {
    title: "ReviewX | 미션형 캠페인 상세",
    description: campaign.description ?? `ReviewX 미션형 캠페인 - ${campaign.title}`,
  };
}

export default function MissionDetailLayout({ children }: { children: React.ReactNode }) {
  return (
    <>
