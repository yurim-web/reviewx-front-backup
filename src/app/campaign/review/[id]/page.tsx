...
import { reviewCampaigns, reviewCampaignsExtended } from "@/data/campaign/review/reviewCampaigns";
...
export default function ReviewDetailPage({ params }: ReviewDetailPageProps) {
  ...
  useEffect(() => {
    ...
    const staticCampaign = reviewCampaignsExtended.find((c) => {
      ...
      const normalizedCampaignId = campaignId.startsWith("review_") ? campaignId.replace(/^review_/, "") : campaignId;
    ...
    if (typeof window !== "undefined") {
      try {
        ...
        if (storedCampaigns) {
          ...
          if (storedCampaign) {
            console.log(`[구매평 캠페인] localStorage에서 캠페인 찾음: ID=${storedCampaign.campaignInfo.id}`);
