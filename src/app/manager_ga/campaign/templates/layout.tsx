 ...
 * GA 관리자 템플릿 관리 레이아웃
 *
 * 목적: 템플릿 관리 페이지의 메타데이터를 설정하는 레이아웃 컴포넌트입니다.
 *
 * 사용 페이지:
 * - /manager_ga/campaign/templates (템플릿 관리 페이지)
 *
 * 주요 기능:
 * - 페이지 메타데이터 설정 (제목, 설명)
...
export const metadata: Metadata = {
  title: 'ReviewX | 템플릿 관리',
  description: 'GA 관리자 템플릿 관리 페이지입니다',
};

/**
 * GA 관리자 템플릿 관리 레이아웃 컴포넌트
 *
