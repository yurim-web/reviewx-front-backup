 ...
 *
 * 학습 포인트:
 * - React 컴포넌트: 페이지를 구성하는 재사용 가능한 컴포넌트입니다
 * - useState Hook: 컴포넌트의 상태를 관리하는 React Hook입니다
 * - 배열 map 함수: 배열 데이터를 순회하며 JSX 요소를 생성합니다
 * - CSS 모듈: 스타일을 컴포넌트별로 격리하여 관리합니다
 * - 조건부 렌더링: 데이터가 있을 때와 없을 때 다른 UI를 표시합니다
 */
