 ...
 * ReviewerDetailPage
 *
 * 목적: GA 관리자가 특정 리뷰어의 상세 정보를 확인합니다.
 *
 * 사용 페이지:
            ...
            if (userAccount) {
              ...
              try {
                ...
                if (userAppliedCampaigns) {
                  const allAppliedCampaigns: StoredUserCampaigns[] =
                    JSON.parse(userAppliedCampaigns);
                  const userCampaigns = allAppliedCampaigns.find(
                    (uc: StoredUserCampaigns) => uc.userId === mappedId
                  );
                  ...
                  if (userCampaigns && userCampaigns.campaigns) {
                    ...
                    const getCampaignInfo = (
                      ...
                      try {
                        ...
                        if (storedCampaigns) {
                          const allCampaigns: StoredCampaignData[] = JSON.parse(storedCampaigns);

                          // ID 매칭 로직 개선 (다양한 ID 형식 지원)
                          const campaign = allCampaigns.find((c: StoredCampaignData) => {
                          ...
                          if (campaign) {
                            // 포인트 정보 찾기 (다양한 경로 확인)
                            const points = campaign.campaignInfo?.points || campaign.points || 0;
                            ...
                            const allStaticCampaigns: StoredCampaignData[] = [
                              ...deliveryCampaigns,
                              ...visitCampaigns,
                              ...reviewCampaigns,
                              ...reporterCampaigns,
                            ...
                            const foundInStatic = allStaticCampaigns.find(
                              (c: StoredCampaignData) => {
                            ...
                            if (foundInStatic) {
                              ...
                              const points =
                                foundInStatic.campaignInfo?.points || foundInStatic.points || 0;
                    ...
                    recentCampaigns = campaigns
                      ...
                      .map((c: StoredAppliedCampaign) => {
                        ...
                        if (actualCampaign) {
                          ...
                          const points =
                            campaignInfoExt.point !== undefined ? campaignInfoExt.point : 0;
