/* ========================================
   🔧 GA 관리자 파트너 상세페이지 레이아웃
   ======================================== */

/**
 * GA 관리자 파트너 상세페이지 레이아웃
 *
 * 목적: 파트너 상세페이지 페이지의 메타데이터를 설정하는 레이아웃 컴포넌트입니다.
 *
 * 사용 페이지:
 * - /manager_ga/member/partners/[id] (파트너 상세페이지 페이지)
 *
 * 주요 기능:
 * - 페이지 메타데이터 설정 (제목, 설명)
...
export const metadata: Metadata = {
  title: 'ReviewX | 파트너 상세페이지',
  description: 'GA 관리자 파트너 상세페이지입니다',
};

/**
 * GA 관리자 파트너 상세페이지 레이아웃 컴포넌트
 *
