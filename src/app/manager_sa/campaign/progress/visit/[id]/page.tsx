/* ========================================
   🏢 SA 관리자 방문형 캠페인 상세 페이지 (동적)
   ======================================== */

/**
 * 방문형 캠페인 진행 현황 상세 페이지 (SA 관리자 버전)
 *
 * 목적: SA 관리자가 진행 현황 테이블에서 특정 방문형 캠페인을 클릭했을 때
...
export default function ManagerVisitProgressDetailPage() {
  ...
  // - 이 페이지는 방문형 캠페인에 특화된 renderCard 함수만 전달합니다
  return (
