...
import ManagerLayoutWrapper from "@/components/manager/common/ManagerLayoutWrapper";
 ...
 */
export default function ManagerSALayout({ children }: { children: React.ReactNode }) {
  return (
