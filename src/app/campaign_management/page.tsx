// 캠페인 관리 메인 페이지
// 사용자가 신청/선정/완료된 캠페인을 관리하고 패널티 정보를 확인하는 페이지

"use client";

import { useState } from "react";
import TabNavigation from "@/components/campaign_management/TabNavigation";
import StatisticsTab from "@/components/campaign_management/StatisticsTab";
import CampaignList from "@/components/campaign_management/CampaignList";
