 ...
 * 방문형 캠페인 신청내역 페이지
 *
 * 목적: 파트너가 생성한 방문형 캠페인에 신청한 사용자들의 목록을 확인하고 관리하는 페이지입니다.
 *
 * 페이지 경로:
 * - /partner/campaign_application/visit
 *
 * 주요 기능:
 * - 방문형 캠페인 기본 정보 표시 (제목, 이미지, 상태, 일정 등)
 * - 신청자/선정자 탭 네비게이션
...
const mockApplicants: Applicant[] = [
  {
    ...
    totalVisits: 650000,
    neighbors: 1500,
    memo: "방문형 캠페인에 관심이 많습니다. 정확한 위치 정보와 상세한 리뷰를 작성하겠습니다.",
    selectionStatus: "미선택",
    channel: "네이버",
  },
  {
    ...
    totalVisits: 900000,
    neighbors: 3000,
    memo: "안녕하세요 :) 방문형 체험에 대한 경험이 풍부합니다. 감사히 사용하겠습니다.",
    selectionStatus: "미선택",
    channel: "네이버 인플루언서",
  },
  {
    ...
    <div className={layoutStyles.container}>
      ...
      <div className={layoutStyles.main_content}>
        ...
        <div className={styles.page_header}>
          <h1 className={styles.page_title}>방문형 캠페인 신청 내역</h1>
        </div>
        ...
        <div className={styles.tab_navigation}>
          ...
          >
            신청 <span className={styles.tab_count}>8</span>
          </button>
          <button
            className={`${styles.tab_button} ${
          ...
          >
            선정 <span className={styles.tab_count}>3</span>
          </button>
        </div>
