 ...
 * 기자단 캠페인 신청내역 페이지
 *
 * 목적: 파트너가 생성한 기자단 캠페인에 신청한 사용자들의 목록을 확인하고 관리하는 페이지입니다.
 *
 * 페이지 경로:
 * - /partner/campaign_application/reporter
 *
 * 주요 기능:
 * - 기자단 캠페인 기본 정보 표시 (제목, 이미지, 상태, 일정 등)
 * - 신청자/선정자 탭 네비게이션
...
const mockApplicants: Applicant[] = [
  {
    ...
    totalVisits: 680000,
    neighbors: 1400,
    memo: "기자단 캠페인에 관심이 많습니다. 전문적이고 상세한 기사를 작성하겠습니다.",
    selectionStatus: "미선택",
    channel: "네이버",
  },
  {
    ...
    totalVisits: 1300000,
    neighbors: 4500,
    memo: "안녕하세요 :) 기자단 활동에 대한 경험이 풍부합니다. 감사히 사용하겠습니다.",
    selectionStatus: "미선택",
    channel: "네이버 인플루언서",
  },
  {
    ...
    <div className={layoutStyles.container}>
      ...
      <div className={layoutStyles.main_content}>
        ...
        <div className={styles.tab_navigation}>
          ...
          >
            신청 <span className={styles.tab_count}>6</span>
          </button>
          <button
            className={`${styles.tab_button} ${
          ...
          >
            선정 <span className={styles.tab_count}>2</span>
          </button>
        </div>
