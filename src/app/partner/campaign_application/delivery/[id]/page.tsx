...
export default function DeliveryCampaignApplicationPage() {
  ...
  // 캠페인 데이터에서 신청자 데이터 추출 (이제 상태에서 가져옴)
  // const allApplicants = campaignData.applicantData.applicants;
  // const allSelectedApplicants = campaignData.applicantData.selectedApplicants;
