 ...
 *
 * 목적: 미션형 캠페인 상세 페이지의 안내사항 섹션을 렌더링합니다.
 *
 * 사용 페이지:
 * - /user/campaign/[id] (미션형 캠페인 상세 > 안내사항 섹션)
 */
...
import { MISSION_GUIDELINE_DEFAULTS } from "@/data/user/campaign_detail/guidelineDefaults";
...
export default function DetailGuidelinesSectionMission({
  ...
  const activeGuidelineTexts = guidelineTexts ?? MISSION_GUIDELINE_DEFAULTS;
