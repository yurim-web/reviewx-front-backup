/* ========================================
   DetailGuidelinesSectionReview 스토리북
   ======================================== */

/**
 * DetailGuidelinesSectionReview.stories
 *
 * 목적: 구매평 캠페인 안내사항 섹션 컴포넌트 스토리 모음
 *
 * 사용 페이지:
 * - Storybook (User/CampaignDetail/Guidelines/DetailGuidelinesSectionReview)
 */
