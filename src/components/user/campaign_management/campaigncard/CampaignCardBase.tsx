 ...
 *
 * 학습 포인트:
 * - React의 children prop: 부모 컴포넌트가 자식 컴포넌트에 내용을 전달할 수 있게 해주는 특별한 prop입니다.
 * - 컴포넌트 재사용성: 공통 UI 구조를 하나의 컴포넌트로 만들어 여러 곳에서 재사용할 수 있습니다.
 * - Next.js Link 컴포넌트: 클라이언트 사이드 라우팅을 지원하는 Next.js의 내장 컴포넌트입니다.
 * - 이벤트 전파 제어: 버튼 클릭 시 상위 요소의 클릭 이벤트가 발생하지 않도록 stopPropagation을 사용합니다.
 */
