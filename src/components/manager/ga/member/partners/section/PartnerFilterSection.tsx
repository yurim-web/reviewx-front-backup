...
import ChannelFilterModal from '@/components/manager/ga/member/partners/filter/ChannelFilterModal';
import DivisionFilterModal from '@/components/manager/ga/member/partners/filter/DivisionFilterModal';
import TypeFilterModal, {
  type PartnerType,
} from '@/components/manager/ga/member/partners/filter/TypeFilterModal';
import StatusFilterModal from '@/components/manager/ga/member/partners/filter/StatusFilterModal';
