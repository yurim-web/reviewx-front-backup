      ...
      <div className={styles.report_stats_grid}>
        ...
        <div className={styles.report_stats_item}>
          ...
          <span className={styles.text}>
            {format_number(report_stats[0].count)}회
          </span>
        </div>
        ...
        <div className={styles.report_stats_item}>
          ...
          <span className={styles.report_stats_separator}>·</span>
          <span className={styles.text}>
            {format_number(report_stats[1].count)}회
          </span>
        </div>
        ...
        <div className={styles.report_stats_item}>
          ...
          <span className={styles.report_stats_separator}>·</span>
          <span className={styles.text}>
            {format_number(report_stats[2].count)}회
          </span>
        </div>
        ...
        <div className={styles.report_stats_item}>
          ...
          <span className={styles.report_stats_separator}>·</span>
          <span className={styles.text}>
            {format_number(report_stats[3].count)}회
          </span>
        </div>
        ...
        <div className={styles.report_stats_item}>
          ...
          <span className={styles.report_stats_separator}>·</span>
          <span className={styles.text}>
            {format_number(report_stats[4].count)}회
          </span>
        </div>
        ...
        <div className={styles.report_stats_item}>
          ...
          <span className={styles.report_stats_separator}>·</span>
          <span className={styles.text}>
            {format_number(report_stats[5].count)}회
          </span>
        </div>
        ...
        <div className={styles.report_stats_item}>
          ...
          <span className={styles.report_stats_separator}>·</span>
          <span className={styles.text}>
            {format_number(report_stats[6].count)}회
          </span>
        </div>
        ...
        <div className={styles.report_stats_item}>
          ...
          <span className={styles.report_stats_separator}>·</span>
          <span className={styles.text}>
            {format_number(report_stats[7].count)}회
          </span>
        </div>
        ...
        <div className={styles.report_stats_item}>
          ...
          <span className={styles.report_stats_separator}>·</span>
          <span className={styles.text}>
            {format_number(report_stats[8].count)}회
          </span>
        </div>
        ...
        <div className={styles.report_stats_item}>
          ...
          <span className={styles.report_stats_separator}>·</span>
          <span className={styles.text}>
            {format_number(report_stats[9].count)}회
          </span>
        </div>
        ...
        <div className={styles.report_stats_item}>
          ...
          <span className={styles.report_stats_separator}>·</span>
          <span className={styles.text}>
            {format_number(report_stats[10].count)}회
          </span>
        </div>
        ...
        <div className={styles.report_stats_item}>
          ...
          <span className={styles.report_stats_separator}>·</span>
          <span className={styles.text}>
            {format_number(report_stats[11].count)}회
          </span>
        </div>
        ...
        <div className={styles.report_stats_item}>
          ...
          <span className={styles.report_stats_separator}>·</span>
          <span className={styles.text}>
            {format_number(report_stats[12].count)}회
          </span>
        </div>
      </div>
    </div>
