    ...
    <div className={`${styles.section_box} ${styles.reject_stats_section}`}>
      <div className={styles.reject_stats_grid}>
        ...
        <div className={styles.reject_stats_item}>
          ...
          <span className={styles.text}>{format_number(3)}회</span>
        </div>
        ...
        <div className={styles.reject_stats_item}>
          ...
          <span className={styles.reject_stats_separator}>·</span>
          <span className={styles.text}>{format_number(19999)}회</span>
        </div>
        ...
        <div className={styles.reject_stats_item}>
          ...
          <span className={styles.reject_stats_separator}>·</span>
          <span className={styles.text}>{format_number(100)}회</span>
        </div>
        ...
        <div className={styles.reject_stats_item}>
          ...
          <span className={styles.reject_stats_separator}>·</span>
          <span className={styles.text}>{format_number(1100)}회</span>
        </div>
      </div>
    </div>
  );
