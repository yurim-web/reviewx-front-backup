...
import CampaignReportModal from '@/components/manager/ga/campaign/progress/modal/CampaignReportModal';
...
export default function RejectedCampaignTable({
  ...
  // 신고 모달 상태 관리
  // 신고 모달이 열려있는지, 어떤 캠페인의 신고 모달인지 관리합니다
  ...
  return (
    <div className={styles.table_section}>
      ...
      {/* 테이블 바디 - 반려 이력 목록을 map 함수로 순회하며 렌더링 */}
