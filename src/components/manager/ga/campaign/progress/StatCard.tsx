 ...
 * 진행 상황 통계 카드 컴포넌트
 *
 * 목적: 진행 상황 페이지 상단에 표시하는 통계 카드입니다.
 *
 * 사용 페이지:
 ...
 * 주요 기능:
 * - 통계 항목과 값을 표시합니다.
 * - 취소된 통계는 빨간색으로 강조 표시합니다.
 *
 */

import StatCardCommon from '@/components/manager/common/campaign/progress/cards/StatCard';
...
interface StatCardProps {
  title: string; // 카드 제목
  value: string; // 통계 값
  isCancelled?: boolean; // 취소된 캠페인인지 (선택)
}
 ...
 * @param title - 카드 제목
 * @param value - 통계 값
 * @param isCancelled - 취소된 캠페인인지 (선택) true인 경우 빨간색으로 표시
 */
