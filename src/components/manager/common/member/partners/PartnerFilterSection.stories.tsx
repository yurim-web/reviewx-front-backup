/**
 * PartnerFilterSection 컴포넌트 스토리북
 *
 * 파트너 필터 섹션 컴포넌트의 다양한 사용 예시를 보여줍니다.
 */

import type { Meta, StoryObj } from "@storybook/react";
import { useState } from "react";
import PartnerFilterSection from "./PartnerFilterSection";

const meta: Meta<typeof PartnerFilterSection> = {
  title: "Manager/Common/Member/Partners/PartnerFilterSection",
  component: PartnerFilterSection,
  tags: ["autodocs"],
  parameters: {
    layout: "fullscreen",
    nextjs: {
 ...
 *
 * 1. 파트너 필터 섹션 컴포넌트
 *    - GA/SA 관리자 파트너 목록 페이지에서 공통 MemberFilterSection을 사용합니다
