/**
 * PenaltyHistoryModal 컴포넌트 스토리북 (파트너 래퍼)
 *
 * 파트너용 패널티 이력 모달 컴포넌트의 다양한 사용 예시를 보여줍니다.
 */
...
const meta: Meta<typeof PenaltyHistoryModal> = {
  title: "Manager/Common/Member/Partners/PenaltyHistoryModal",
 ...
 * 학습 포인트:
 *
 * 1. 파트너용 패널티 이력 모달 컴포넌트
 *    - GA/SA 관리자 파트너 상세 페이지에서 공통 PenaltyHistoryModal을 사용합니다
 *    - 스타일과 데이터를 전달하여 렌더링합니다
 *
 * 2. 데이터 변환
 *    - PenaltyHistoryItem을 CommonPenaltyHistoryItem으로 변환합니다
 *    - 파트너는 reason이 없고 type만 유지하여 사용합니다
 *
 * 3. 스타일 전달
