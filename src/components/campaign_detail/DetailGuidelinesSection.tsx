...
interface CampaignGuidelinesSectionProps {
  ...
  requirements?: RequirementItem[]; // 페이지별 요구사항 아이콘/텍스트 목록
      ...
      {showKeyword && (
        <div className={styles.info_item_box}>
          ...
          <div className={styles.content_box}>
            <div className={styles.keyword_text_box}>자유롭게 입력하세요.</div>
          </div>
        </div>
      )}
...
// 학습 포인트
// ========================================
// 1. 조건부 렌더링: && 연산자로 조건이 true일 때만 렌더링
// 2. 선택적 Props: showRequirements?, onCopyKeyword?
// 3. 기본값: showRequirements = true
// 4. 컴포넌트 재사용: AdditionalGuidelines 임포트
// 5. 이벤트 핸들러: onClick={onCopyKeyword}
