 ...
 *
 * 학습 포인트:
 * - useState: React의 상태 관리 Hook입니다
 * - 현재 선택된 메뉴를 상태로 관리하여 활성화된 메뉴를 표시합니다
 * - Link 컴포넌트는 Next.js에서 클라이언트 사이드 라우팅을 제공합니다
 * - 조건부 렌더링: 삼항 연산자를 사용하여 선택된 메뉴에 다른 스타일을 적용합니다
 */
...
export default function SidebarMenu() {
  ...
  const menuCategories: MenuCategory[] = [
    ...
    {
      title: '커뮤니티',
      items: [{ label: '게시글 목록', path: '/manager_ga/community/posts' }],
    },
  ];
