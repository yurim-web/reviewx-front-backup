...
import styles from "../../styles/campaign/application_modal.module.css";

interface ApplicationModalType3Props {
  isOpen: boolean;
  onClose: () => void;
}

export default function ApplicationModalType3({
  isOpen,
  onClose,
}: ApplicationModalType3Props) {
