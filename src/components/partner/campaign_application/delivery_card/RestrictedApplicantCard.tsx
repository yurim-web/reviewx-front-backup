...
interface RestrictedApplicantCardProps {
  /** 이용제한 신청자 정보 객체 */
  applicant: Applicant;
  /** 배송 주소 정보 (배송형 특화) */
 ...
 * - 시각적으로 제한된 상태임을 강조
 *
 * @param props - RestrictedApplicantCardProps 타입의 props
 * @returns JSX 요소
 */
export default function RestrictedApplicantCard({
  applicant,
  deliveryAddress,
}: RestrictedApplicantCardProps) {
  /**
   * 채널 아이콘 경로 가져오기
   *
   * 📌 channel_logo_map 사용:
