/**
 * ReviewRejectedReviewCard 컴포넌트 스토리북
 *
 * 구매평 반려 카드 (리뷰 확인) 컴포넌트의 다양한 사용 예시를 보여줍니다.
 */

import type { Meta, StoryObj } from "@storybook/react";
import React from "react";
import ReviewRejectedReviewCard from "./ReviewRejectedReviewCard";
...
const mockApplicant: ExperienceApplicant = {
  ...
  reviewType: 5, // 리뷰 확인 (반려 처리)
};

const meta: Meta<typeof ReviewRejectedReviewCard> = {
  title: "Partner/CampaignContents/CardType/PurchaseReview/ReviewRejectedReviewCard",
  component: ReviewRejectedReviewCard,
  tags: ["autodocs"],
  parameters: {
    layout: "padded",
  },
...
type Story = StoryObj<typeof ReviewRejectedReviewCard>;

// 안정적인 render 함수를 컴포넌트 외부에 정의 (깜빡임 방지)
// args를 받아서 컴포넌트에 전달해야 합니다
const renderReviewRejectedReviewCard = (args: any) => {
  return React.createElement(ReviewRejectedReviewCard, args);
};

/**
 * 기본 반려 카드 (리뷰 확인)
 *
 * 리뷰 확인 후 반려 처리하는 카드입니다.
 */
export const Default: Story = {
  render: renderReviewRejectedReviewCard,
  args: {
 ...
 *
 * 2. 리뷰 확인 기능
 *    - onCheckReview로 리뷰를 확인할 수 있습니다
 *    - 리뷰 확인 후 반려 처리를 할 수 있습니다
 *
 * 3. 반려 처리 기능
