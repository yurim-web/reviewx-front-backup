    ...
    <article className={styles.form_group}>
      ...
      <div className={styles.notice_content}>
        <ul>
          ...
          <li>허위 · 과장 · 비방 · 타사 비교 등 소비자를 오인시킬 수 있는 표현은 금지됩니다.</li>
          <li>선정 후 제공 내역 및 배송지/방문지 변경은 불가합니다.</li>
          <li>당첨 후 취소 시 패널티가 발생합니다.</li>
          <li>미션이 제대로 지켜지지 않을 시 수정 요청이 있을 수 있습니다.</li>
          <li>
            리뷰는 반드시 해당 제품/서비스 단독으로 촬영 · 작성해야 합니다. 타 제품/서비스와 함께
            업로드 시 재작성 요청이 있을 수 있습니다.
          </li>
          <li>
            리뷰는 반드시 지정된 기간 내 등록해야 합니다. 기간을 초과할 경우 제공 내역 비용이
            청구되거나 패널티가 발생합니다.
          </li>
          <li>
            작성된 콘텐츠는 최소 6개월간 유지해야 하며, 유지하지 않을 경우 패널티가 발생합니다.
          </li>
          <li>생성형 AI로 작성된 콘텐츠 및 이미지는 수정 요청 또는 패널티가 발생합니다.</li>
